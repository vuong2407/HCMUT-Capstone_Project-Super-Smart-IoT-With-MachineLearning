            ...
            <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0 hidden sm:block">
                ...
                <div
                    ...
                    <div class="h-20 w-20 rounded-full border overflow-hidden">
                        <img src="/images/chatgpt.png" alt="Avatar" class="h-full w-full" />
                    </div>
                    <div class="text-sm font-semibold mt-2">Chat GPT.</div>
                    <div class="text-xs text-gray-500">Support by OpenAI</div>
                </div>
                <div class="flex flex-col mt-8">
                    ...
                    <div class="flex flex-col space-y-1 mt-4 -mx-2 h-54 overflow-y-auto">
                        <button class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                            <div class="flex items-center justify-center h-8 w-8 bg-indigo-200 rounded-full">
                                N
                            </div>
                            <div class="ml-2 text-sm font-semibold">Nha Le Thanh</div>
                        </button>
                        <button class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2">
                            <div class="flex items-center justify-center h-8 w-8 bg-gray-200 rounded-full">
                                V
                            </div>
                            <div class="ml-2 text-sm font-semibold">Vuong Nguyen Van</div>
                            <div
                    ...
                    <div class="flex flex-col h-full overflow-x-auto mb-4">
                        <div class="flex flex-col h-full">
                            <div v-for="message in messages" :key="message.id" class="grid grid-cols-12 gap-y-2">
                                <div v-if="message.isBot === false" class="col-start-6 col-end-13 p-3 rounded-lg">
                                ...
                                <div v-if="message.isBot === true" class="col-start-1 col-end-8 p-3 rounded-lg">
...
export default {
    ...
    methods: {
        async sendMessage() {
            ...
            this.newMessage = '';
            try {
                const response = await axios.post(this.sendMessageGpt, {
                    message: message,
                }).then((res) => {
