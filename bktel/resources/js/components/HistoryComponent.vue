<template>
    <div>
        <div class="mt-[30px] flex justify-center text-center">
            <span class="font-bold text-[30px]"> History </span>
        </div>
        <div
            class="overflow-x-auto relative shadow-md sm:rounded-lg mt-[30px] mx-[10px]"
        >
            <table
            ...
            >
                ...
                >
                    <tr>
                        ...
                        <th scope="col" class="py-3 px-6">Time Update</th>
        ...
        <div class="mt-[30px]">
            ...
            <div class="flex flex-row justify-end mr-[40px]">
                <button
                    class="w-[80px] bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded-[10px]"
                >
                    Export
                </button>
            </div>
