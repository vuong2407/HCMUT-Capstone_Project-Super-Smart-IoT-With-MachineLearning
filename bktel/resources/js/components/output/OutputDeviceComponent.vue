<template>
    <div> 
        <div class="flex justify-start pl-8 text-[26px] font-bold">Add output device</div>
    ...
    export default {
        ...
        methods:{
            saveData(){
                this.errorForm = null;
                axios.post(this.saveOutputDeviceUrl, this.device)
                .then((res )=> {
                    console.log(res) ;
                    this.fetchData();
                    this.device = {} ;
            ...
            fetchData(){
                this.allDevices = [];
                axios.get(this.getAllOutputDevice, {
                    param: {
